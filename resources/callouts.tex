...
\definecolor{tipcolor}{RGB}{167, 51, 255} % Purple
\definecolor{warningcolor}{RGB}{229, 192, 123} % Orange
\definecolor{attentioncolor}{RGB}{224, 108, 117} % Red
\definecolor{helpcolor}{RGB}{255, 215, 0} % Yellow
\definecolor{examplecolor}{RGB}{152, 195, 121} % Green
...
\newenvironment{helpblock}[1]
  {\begin{prettybox}{helpcolor}{\faQuestionCircle}{#1}}
  {\end{prettybox}}

\newenvironment{errorblock}[1]
  {\begin{prettybox}{attentioncolor}{\faTimesCircle}{#1}}
  {\end{prettybox}}

\newenvironment{exampleblock}[1]
  {\begin{prettybox}{examplecolor}{\faListUl}{#1}}
  {\end{prettybox}}
